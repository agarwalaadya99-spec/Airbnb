...
const FeatureCards = ({ onUploadClick, onCameraClick }) => {
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-12">
            ...
            <div className="bg-[#FF385C] rounded-2xl p-6 sm:p-8 shadow-sm relative overflow-hidden group hover:shadow-md transition-all duration-300">
                <div className="relative z-10 h-full flex flex-col justify-between">
                    <div>
                        ...
                        <h3 className="text-[20px] sm:text-[22px] font-bold text-white mb-2 sm:mb-2.5 tracking-tight">Take Live Verified Photo</h3>
                    ...
                    <button className="mt-6 sm:mt-8 w-full bg-white text-[#FF385C] font-semibold text-[14px] py-3 px-6 rounded-xl flex items-center justify-center gap-2 hover:bg-gray-50 transition-colors shadow-sm active:scale-[0.98] transform" onClick={onCameraClick}>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6 sm:p-8 shadow-sm flex flex-col justify-between">
                <div>
                    <h3 className="text-[20px] font-bold text-gray-900 mb-2 sm:mb-2.5 tracking-tight">Upload & Verify Media</h3>
                    <p className="text-[#717171] text-[13px] leading-relaxed max-w-[340px] mb-6 sm:mb-8">
