          ...
          <div className="flex items-center gap-3 sm:gap-6 shrink-0">
            ...
            >
              ...
              <div className="w-8 h-8 rounded-full overflow-hidden border border-gray-100 hidden sm:block">
                <img src="/image0212.jpeg" className="w-full h-full object-cover" alt="User Profile" />
              </div>
            </button>
          </div>
        </div>
              ...
              <div className="mt-auto">
                 <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-[24px]">
                    <div className="w-12 h-12 rounded-full overflow-hidden border-2 border-white shadow-sm">
                       <img src="/image0212.jpeg" className="w-full h-full object-cover" alt="Aadya Agarwal" />
                    </div>
                    <div>
