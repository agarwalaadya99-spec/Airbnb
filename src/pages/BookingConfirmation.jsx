               ...
               <div className="p-8 space-y-8">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-8 border-b border-surface-low">
                     <div className="flex items-center gap-4">
                        <img 
                          src="https://lh3.googleusercontent.com/aida-public/AB6AXuDJ0jgH8h9ks1vmgYVZatJxDnP4HF2CVkUMOz69MV2pop26QsHR7s7YdMFeBe5WrKkcq7q2-Kxo3w4u6nHl2EzGDInUL-s-8hy4vqm1OsBG-bJ1TYtAncVYXBhvtAVGro2_OwmPN5_Q0bAiLysRwBOV8rXAQOBpNZ34gKdOZHXiP8VM0OK4Aey0EVd5fxowsKL1hF29uUI-zG_kpxUl8RuOff1G9-yxVTApeyfefX14tegKHj0juzk2yuwF__3Y5WBYLYOaBDPL3Y4" 
